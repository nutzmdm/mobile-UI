 ...
 */
     ...
     * Defining Login Form
     */
    $form = new HTML_QuickForm('Form', 'post', './smartphones.php');
    ...
    $tpl->display("modules/mobile-UI/include/login.ihtml");
    require_once("modules/mobile-UI/include/processLogin.php");