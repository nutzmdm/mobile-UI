...
<?php include ("./modules/mobile-UI/include/monitoring/services/monitoringServiceMainJS.php");?>
...
<div data-role="popup" id="popupSearch" class="div_popup">
	...
	<div id="searchPopup" class="ui-field-contain">
		<form id="formSearch" class="ui-field-contain">
			...
			<label id="hostSearchInputLabel" for="hostSearchInput" data-mini="true" ></label>
				<input type="search" name="host_search" id="hostSearchInput" value="<?php echo $monitoringHostSearch;?>" data-mini="true"><!-- host -->
			<br />
			<label id="serviceSearchInputLabel" for="serviceSearchInput" data-mini="true" ></label>
				<input type="search" name="search" id="serviceSearchInput" value="<?php echo $monitoringServiceSearch;?>" data-mini="true"><!-- service -->
			<br />
			<label id="statusSearchSelectLabel" for="statusSearchSelect" class="select"></label>
				<select name="statusFilter" id="statusSearchSelect" data-mini="true" data-inline="true"></select><!-- statut -->
			<br /><br />
			<label id="serviceSearchOutputLabel" for="output_search" data-mini="true" ></label>
				<input type="search" name="output_search" id="output_search" value="<?php echo $monitoringOutputSearch;?>" data-mini="true"><!-- statut détaillé-->
			<!--<br />
			<label id="collectorSearchSelectLabel" for="collectorSearchSelect" class="select"></label>
				<select name="select_instance" id="collectorSearchSelect" data-mini="true" data-inline="true"></select> collector -->
			<!--<br /><br />
			<label id="hostgroupSearchSelectLabel" for="hostgroupSearchSelect" class="select"></label>
				<select name="hostgroups" id="hostgroupSearchSelect" data-mini="true" data-inline="true"></select><br /> hostgroup -->
			<br /><br />
		...
		<form id="formReset" class="ui-field-contain">
			...
			<?php 	unset ($_SESSION['centreon']->historySearchService);?>
			<!--<input type="hidden" name="statusFilter" value='""'> -->
			<?php 	unset ($_SESSION['centreon']->historySearchOutput);?>
...
<div data-role="content" class="ui-content">
	...
	<div id="content" data-role="content" class="ui-content">
		...
		<ul id="showService" data-role="listview" data-corners="false" data-inset="true"></ul>
	</div>
</div>
