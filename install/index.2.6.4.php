...
if (isset($_SESSION["centreon"])) {
    ...
    //*******Patch for mobile version --->
		...
		else 	{header('Location: main.php');}//***** <--- End of patch for mobile version
}
...
}//** <--- End of patch for mobile version
...
if (version_compare(phpversion(), '5.0') < 0){
	...
	else{//***** <--- End of patch for mobile version
